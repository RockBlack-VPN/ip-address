...
:white_check_mark:Если после добавления маршрутов Instagram, Twitter и другие сервисы, он не работает, то нужно добавить **DNS DoT** и затем очистить кэш и куки приложения.
